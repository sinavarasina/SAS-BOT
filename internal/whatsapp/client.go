...
func InitClient(dsn string, appDB *sqlx.DB, ctx context.Context, sheetsClient *sheets.SheetsClient, driveClient *uploaderDriveClient) (*whatsmeow.Client, error) {
	...
	client.AddEventHandler(EventHandler(client, appDB, sheetsClient, driveClient))
